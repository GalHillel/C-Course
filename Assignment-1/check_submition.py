...
def test_output_vs_expected(prog, input_f, expected_f):
    ...
    if not filecmp.cmp('tmp_out.txt', expected_f):
        print("difference found in ./%s < %s vs " %
              (prog, input_f), expected_f)
        passed = 0
...
def main():
    ...
    test_output_vs_expected(
        "mains", "../inputs/input1.txt", "../outputs/output1.txt")
    test_output_vs_expected(
        "maindloop", "../inputs/input2.txt", "../outputs/output2.txt")
    test_output_vs_expected(
        "maindrec", "../inputs/input3.txt", "../outputs/output3.txt")
    test_output_vs_expected(
        "maindrec", "../inputs/input4.txt", "../outputs/output4.txt")
